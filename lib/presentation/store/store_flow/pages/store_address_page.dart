...
//           return BlocListener<StorePageCubit, StorePageState>(
//             listener: (context, state) {
//               state.maybeMap(
//                 error: (errorState) {
//                   errorState.storeFailure.maybeMap(
//                       serverError: (_) {
//                         //TODO: Add server error popup
//                       },
//                       orElse: () {});
//                 },
//                 orElse: () {},
...
//                                         Text(
//                                           'pincode',
//                                           style: context.everythngTextTheme
//                                               .headline4Bold!,
//                                         ),
//                                         SizedBox(
...
//                                 title: 'Continue',
//                                 onTap: () {
//                                   context.read<StoreFormCubit>().setAddress(
//                                       Address(
...
//                                   //context.read<StoreFormCubit>().setStore();
//                                 },
//                               ),
//                             )
//                           ],
